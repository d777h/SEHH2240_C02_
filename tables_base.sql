...
(
    familiarity_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, 
    familiarity_level ENUM('Intermediate', 'Advacneed', 'Proficient') NOT NULL,
); 
...
(
    ...
    event_id INT UNIQUE FOREIGN KEY REFERENCES Events(event_id) DEFAULT NULL ON DELETE CASCADE,
    avenue_id INT UNIQUE FOREIGN KEY REFERENCES Avenue_Info(avenue_id) DEFAULT NULL ON DELETE CASCADE,
    artist_id INT UNIQUE FOREIGN KEY REFERENCES Artists(artist_id) DEFAULT NULL ON DELETE CASCADE, 
    show_id INT UNIQUE FOREIGN KEY REFERENCES Shows(show_id) DEFAULT NULL ON DELETE CASCADE,
    event_id INT UNIQUE FOREIGN KEY REFERENCES Events(event_id) DEFAULT NULL ON DELETE CASCADE, 
